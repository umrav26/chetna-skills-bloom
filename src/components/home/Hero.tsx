...
const Hero = () => {
  return (
    <section className="relative bg-gradient-to-br from-background to-muted/50 overflow-hidden">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute right-0 top-20 w-64 h-64 rounded-full bg-chetna-blue/10 animate-float" />
        <div className="absolute left-20 bottom-20 w-48 h-48 rounded-full bg-chetna-green/10 animate-float" style={{ animationDelay: '1s' }} />
        <div className="absolute top-40 left-1/4 w-32 h-32 rounded-full bg-chetna-peach/10 animate-float" style={{ animationDelay: '2s' }} />
      </div>
